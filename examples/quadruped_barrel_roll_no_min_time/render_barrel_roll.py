...
DEFAULT_INPUT = SCRIPT_DIR / "quadruped_barrel_roll_no_min_time.npz"
...
def load_trajectory(filename: Path) -> tuple[np.ndarray, np.ndarray, np.ndarray]:
    ...
    return states, node_times, phase_times.reshape(-1)
