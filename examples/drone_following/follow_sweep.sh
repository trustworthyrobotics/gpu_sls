...
SWEEP_DIR="/home/jeff/trustworthroboticsgroup/ICRA2026/min_time/gpu_sls/examples/plan_drone_racing_obstacle/e_mag_sweep"
...
for E_MAG in "${E_MAGS[@]}"; do
    ...
    PLAN_DIR="$SWEEP_DIR/E_mag_${TAG}"
    PLAN="$PLAN_DIR/multiphase_trajectory.npz"
